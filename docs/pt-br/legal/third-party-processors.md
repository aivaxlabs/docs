...
A coluna de lei de proteção de dados resume os principais frameworks identificados na política de privacidade atual ou adendo de processamento de dados de cada provedor. A aplicabilidade pode variar conforme a entidade contratante, localização do titular dos dados e região de processamento.
...
| [Twitter/X](https://developer.x.com/) | Ferramentas integradas de busca e leitura de postagens no X/Twitter | [EU/UK GDPR, Swiss FADP, CCPA, and LGPD](https://x.com/en/privacy) |
...
| [OpenRouter](https://openrouter.ai/) | Roteamento de modelo, fallback e síntese de fala | [GDPR, CCPA/CPRA, and applicable U.S. state privacy laws](https://openrouter.ai/privacy/) |
...
| [Google Vertex AI](https://cloud.google.com/vertex-ai) | Famílias de modelos Gemini e outros da Google | [EU/UK GDPR, Swiss FADP, and CCPA/CPRA](https://cloud.google.com/terms/data-processing-addendum/) |
...
| [Nebius](https://nebius.com/) | Famílias de modelos suportados pela Nebius | [EU/UK GDPR, Dutch GDPR Implementation Act, and Swiss FADP](https://docs.nebius.com/legal/dpa) |
| [Fireworks AI](https://fireworks.ai/) | Famílias de modelos suportados pela Fireworks | [EU/UK GDPR, CCPA/CPRA, and applicable U.S. state privacy laws](https://fireworks.ai/privacy-policy) |
| [Novita](https://novita.ai/) | Famílias de modelos suportados pela Novita | [CCPA/CPRA](https://novita.ai/legal) |
| [Azure](https://azure.microsoft.com/) | Famílias de modelos suportados pela Azure | [EU/UK GDPR, CCPA/CPRA, and PIPEDA](https://www.microsoft.com/licensing/docs/view/Microsoft-Products-and-Services-Data-Protection-Addendum-DPA) |
...
Por padrão, a AIVAX não utiliza Conteúdo de Entrada do Gerente de Conta, Conteúdo Gerado ou Conversas para treinar modelos proprietários da AIVAX. Registros elegíveis de RAG anonimizado e reclassificação são usados para desenvolvimento de modelo somente quando um Gerente de Conta autorizado habilita o programa opcional descrito em [Data Collecting](/docs/pt-br/data-collecting). Indexação e armazenamento de documentos são excluídos.

Provedores de terceiros e agregadores podem ter suas próprias regras de processamento, retenção, monitoramento de abuso e melhoria de modelo. O modelo selecionado, provedor, ferramenta ou integração determina qual terceiro recebe os dados para uma solicitação específica.
