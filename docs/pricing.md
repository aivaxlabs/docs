...
| <a id="agentic-validations"></a>Agentic Validations | - Selected model or AI Gateway: its regular inference rates<br>- `low` profile — simulated user: input **$0.25/M tokens**, cached input **$0.025/M tokens**, output **$1.50/M tokens**; judge: input **$0.30/M tokens**, cached input **$0.03/M tokens**, output **$2.50/M tokens**<br>- `medium` profile (default) — simulated user and judge, each: input **$0.75/M tokens**, cached input **$0.075/M tokens**, output **$3.75/M tokens**<br>- `high` profile — simulated user: input **$0.75/M tokens**, cached input **$0.075/M tokens**, output **$3.75/M tokens**; judge: input **$1.25/M tokens**, cached input **$0.15/M tokens**, output **$4.25/M tokens** |
| **RAG and collections** |
